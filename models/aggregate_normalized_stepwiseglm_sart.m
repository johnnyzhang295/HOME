...
tabl = table(t,tl,data(:,1),data(:,2),data(:,3),data(:,4),sart,...
    'VariableNames',{'TrialOrder','Taskload','HR','SDNN','pNN50','HFn','SART'});

mdl = stepwiseglm(tabl,'SART~TrialOrder*Taskload*HR*SDNN*pNN50*HFn','ResponseVar','SART','Intercept',true,...
    'Criterion','sse');
figure;
