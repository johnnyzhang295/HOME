...
load('type_3_ModelWorkloadPredictions.mat');
load('type_3_workload_loocvB.mat');
...
formula="Type 3 Workload Ordinal Regression Model Performance";
topTitle = formula;
...
for i=1:12:180
    subplot(3,5,j);
    hold on;
    plot(data.Workload(i:i+11),LOOCV_B(i:i+11),'o','Color',ColOrd(j,:), 'HandleVisibility','off');
...
formula="Type 3 LOOCV B Workload Ordinal Regression Model Performance";
topTitle = formula;
