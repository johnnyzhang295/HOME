...
data.SART = [];
% This is from regression stepwise
formula = 'Workload ~ 1 + pNN50 + HR*SDNN + HR*Taskload + pNN50:TrialOrder + RspAmp:RspRate + RspRate*SCMeanPupilDiameter + RspRate*Taskload + SCMeanPupilDiameter*Taskload + Taskload:TrialOrder';
...
topTitle = 'Workload LOOCV Linear Regression Model';
suptitle(topTitle);
