...
%Step 1: Stepwise to determine formula
% formula = strcat('Workload ~ 1 + Taskload*HR + Taskload:SCMeanPupilDiameter + TrialOrder:Taskload',...
...
%Step 2: Use manual + Correlation plot
formula = strcat('Workload ~ 1 + Age + HR*RspAmp + SDNN*SCMeanPupilDiameter + RspAmp*RspRate',...
    '+ RspRate*SCMeanPupilDiameter + RspRate*Sex+ RspRate*Taskload + ',...
    'SCMeanPupilDiameter*TrialOrder + SCBlinkCount*Sex');
